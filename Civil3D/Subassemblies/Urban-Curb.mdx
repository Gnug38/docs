...
| --- | --- | --- | --- | --- |
| Insertion\_Point | Attachment Point | InsertionPoint | InsertionPoint\_TopBack | Attachment Point |
| Side | Side | Side | Right | Determines whether the subassembly is placed left or right. |
| Dimension\_H | Curb Depth | Double | 0.5 | Curb Depth |
| BackAttachPoint\_Visibility | Show Back of Curb Attach Point | Yes/No | No | Toggles the back curb attachment point on and off. |
| Dimension\_G | Back of Curb Attachment Depth | Double | 0.25 | This has a 0.01' offset from back-attached subassembly. Subtract subassembly by 0.01 to retain exact distance. |
| FlowLine\_TopFront\_Set | (TFC) Set by Height or Grade | FlowLine\_TopFront | FlowLine\_TopFront\_Depth | Controls whether the flowline to top front face difference is controlled by grade or height. |
| Dimension\_C | FlowLine "FL" to TopFront "Face" Distance | Double | 0.5 | Distance from Flow Line to Top Front "Face" point. |
| Dimension\_D | FlowLine "FL" to TopFront "Face" Height | Double | 0.5 | Height from Flow Line to Top Front "Face" point. |
| Dimension\_D1 | FlowLine "FL" to TopFront "Face" Grade | Grade | 100.00% | Grade from Flow Line to Top Front "Face" point. |
| TopFront\_TopBack\_Set | Top Front "Face" to Top Back "TBC" Set by Height or Grade | TopFront\_TopBack | TopFront\_TopBack\_Grade | Controls whether the top front face to top back curb difference is controlled by grade or height. |
| Dimension\_E | Top Front "Face" to Top Back "TBC" Distance | Double | 0.5 | Distance from Top Front "Face" to Top Back "TBC" point. |
| Dimension\_F | Top Front "Face" to Top Back "TBC" Height | Double | 0 | Height from Top Front "Face" to Top Back point. |
| Dimension\_F1 | Top Front to Top Back Grade | Grade | 0.00% | Grade from Top Front "Face" to Top Back point. |
| InsideBottomPointCode | Inside Bottom Point Code | String | Curb\_Sub | User defined inside bottom point code relative to the insertion point. |
| OutsideBottomPointCode | Outside Bottom Point Code | String | Curb\_Sub | User defined outside bottom point code relative to the insertion point. |
| BottomLinkCode | Bottom Link Code | String | Curb\_Sub | User defined bottom link code. |
